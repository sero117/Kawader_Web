...
const COMMANDS: Command[] = [
  ...
  {
    labelAr: 'الأقسام', labelEn: 'Sections',
    keywords: ['sections', 'أقسام', 'قسم', 'section', 'department'],
    route: '/dashboard/manager/branches',
    hint: 'اختر فرعاً أولاً',
  ...
  {
    labelAr: 'الموظفين', labelEn: 'Employees',
    keywords: ['employees', 'موظفين', 'موظف', 'employee', 'staff', 'عمال'],
    route: '/dashboard/manager/branches',
    hint: 'الفروع ← الأقسام ← الموظفين',
        ...
        @for (cmd of filtered(); track cmd.route; let i = $index) {
          ...
          >
            ...
            <span class="cp-item-labels">
              ...
              <span class="cp-item-en">{{ cmd.hint ?? cmd.labelEn }}</span>
            </span>
            @if (activeIdx() === i) {
